...
!(function (e, t) {
  ...
  var l = "4.0.0-pre 55cd3a44368d529326b6d9b16ff7c0204fee5516",
    c = /HTML$/i,
    te = function (e, t) {
  ...
  te.extend(te.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        if (!r && !c.noBubble && !v(n)) {
          for (
            s = c.delegateType || d, Nt.test(s + d) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            p.push(o), (a = o);
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(f.length)),
            v.data &&
              ...
              ((f += (qt.test(f) ? "&" : "?") + v.data), delete v.data),
            !1 === v.cache &&
              ((f = f.replace(It, "$1")),
  ...
  return (
    (te.noConflict = function (e) {
      return (
        J.$ === te && (J.$ = nn), e && J.jQuery === te && (J.jQuery = tn), te
      );
    }),
